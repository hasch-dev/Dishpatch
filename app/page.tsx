...
import { Calendar, Eye, UtensilsCrossed, Plus } from "lucide-react";
import Navbar from "@/components/navbar";
import Footer from "@/components/footer";

// Import our new extracted components
import TestimonialsSection from "@/components/home/testimonials-section";
import SystemGatewaysSection from "@/components/home/system-gateways";
  ...
  return (
    <div className="min-h-screen bg-background text-foreground antialiased selection:bg-primary selection:text-primary-foreground" id="system">
      ...
      <main>
              ...
              <Reveal delay={0.3}>
                <div className="flex flex-col gap-10 items-start">
                  ...
                  <div className="flex flex-wrap gap-6 items-center">
                    <Link href="/auth/login" className="group relative flex items-center justify-center">
                    ...
                    <Link href="/auth/sign-up" className="group flex items-center gap-4 text-[10px] font-bold uppercase tracking-[0.4em] text-muted-foreground hover:text-primary transition-colors">
                      Cook With Us
        ...
        {/* ABOUT US */}
        <section id="about" className="py-40 bg-background relative overflow-hidden border-t border-border">
          <div className="mx-auto max-w-6xl px-8">
            <div className="grid lg:grid-cols-5 gap-16 items-center">
              <div className="lg:col-span-3 space-y-12 pr-0 lg:pr-12">
                <Reveal>
                  <h2 className="text-[10px] font-bold uppercase tracking-[0.6em] text-primary mb-8">About Us</h2>
              ...
              <div className="lg:col-span-2 space-y-8 bg-background p-12 border border-border shadow-2xl relative">
                ...
                <div className="opacity-60 space-y-4">
                  <p className="text-[10px] font-bold uppercase tracking-widest">We are not a restaurant.</p>
                  <p className="text-[10px] font-bold uppercase tracking-widest">We are not a traditional catering service.</p>
                </div>
                <hr className="border-primary/30" />
                <p className="text-base font-light text-muted-foreground leading-relaxed">
                  We are a culinary system designed to deliver great food in three ways:
        ...
        {/* COMPONENTIZED: Testimonials & Shared Moments */}
        <TestimonialsSection />

        {/* HOW IT WORKS */}
        <section id="how-it-works" className="py-32 border-b border-border bg-muted/10">
          <div className="mx-auto max-w-7xl px-8">
            <div className="mb-20">
              <span className="text-primary font-bold text-[10px] uppercase tracking-[0.5em]">The Process</span>
              <h2 className="text-5xl font-black uppercase tracking-tighter mt-4">How it happens.</h2>
            </div>

            <div className="grid md:grid-cols-3 gap-0 border border-border bg-background shadow-xl">
              {[
                { icon: <Calendar className="w-5 h-5" />, title: "Book", desc: "Pick a date and tell us what you're craving through our simple booking tool." },
                { icon: <Eye className="w-5 h-5" />, title: "Preview", desc: "Meet your chef and see the menu ideas we've put together just for you." },
                { icon: <UtensilsCrossed className="w-5 h-5" />, title: "Execute", desc: "Our chef arrives at your place to turn fresh ingredients into a meal to remember." },
              ].map((item, i) => (
                <div key={i} className="p-14 group hover:bg-primary/5 transition-colors border-b md:border-b-0 md:border-r last:border-r-0 border-border">
        ...
        {/* COMPONENTIZED: Gateways & Stockhouse */}
        <SystemGatewaysSection />

        {/* READY TO JOIN */}
        <section id="gift" className="py-36 bg-background relative flex items-center justify-center overflow-hidden">
            ...
            <Reveal>
              <div className="relative inline-block mb-12">
                ...
                <h2 className="text-6xl md:text-8xl lg:text-9xl font-black uppercase tracking-tighter leading-[0.8]">
                  Savor <br />
                  <span className="text-primary italic font-medium lowercase tracking-normal">the moment.</span>
                </h2>
                <div className="mt-8 flex items-center justify-center gap-4 opacity-30">
                  <span className="text-[10px] font-bold uppercase tracking-[0.8em]">Real Food</span>
                  <Plus className="w-3 h-3" />
                  <span className="text-[10px] font-bold uppercase tracking-[0.8em]">Real People</span>
                </div>
              </div>
